    ...
    setState(() {
      model = [
        new ToolModel(
            ...
            type: "Fetal Growth",
            routeUrl: "/homeWeb?url=${preferences.getString("fetal_view")}"),
        new ToolModel(
            imageUrl: "assets/affirmation.png",
            type: "Affirmation",
            routeUrl:
                "/homeWeb?url=${preferences.getString("affirmation_view")}"),
        new ToolModel(
            imageUrl: "assets/heart.png",
            type: "Prenatal Physiology",
            routeUrl:
                "/homeWeb?url=${preferences.getString("physiology_view")}"),
        new ToolModel(
        ...
        new ToolModel(
            ...
            type: "Mother’s Meals",
            routeUrl: "/homeWeb?url=${preferences.getString("food_view")}"),
        new ToolModel(
            imageUrl: "assets/mum-pappa.png",
            type: "Father cares Mother’s",
            routeUrl: "/homeWeb?url=${preferences.getString("tips_view")}"),
      ];
    });
  }
