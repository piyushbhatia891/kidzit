...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        Routes.INTRODUCTION:(context)=>IntroPage(),
        Routes.SPLASH:(context)=>SplashScreen(),
        Routes.LOGIN_OTP:(context)=>LoginOtpPage(),
        Routes.HOME:(context)=>WidgetsPage(),
        Routes.TOOLS:(context)=>ToolsPage(),
        Routes.YOGA:(context)=>YogaPage(),
        Routes.WEIGHT_DETAILS:(context)=>WeightPage(),
        Routes.WEIGHT_LIST:(context)=>WeightListPage(),
        Routes.WEIGHT_ADD:(context)=>EditWeightPage(),
        Routes.KICK_DETAILS:(context)=>BabyKicksPage(),
        Routes.GLASS_DETAILS:(context)=>GlassPage(),
        Routes.HOME_WEB:(context)=>HomeWebPage()
      },
